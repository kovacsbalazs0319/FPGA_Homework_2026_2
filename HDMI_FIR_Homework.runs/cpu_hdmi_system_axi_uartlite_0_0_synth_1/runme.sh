...
HD_PWD='C:/Users/Balazs/Desktop/MSC1/FPGA/homework/HDMI_FIR_Homework.runs/cpu_hdmi_system_axi_uartlite_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log cpu_hdmi_system_axi_uartlite_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source cpu_hdmi_system_axi_uartlite_0_0.tcl
