...
(* CHECK_LICENSE_TYPE = "cpu_hdmi_system_fir_coeff_bank_axi_0_2,fir_coeff_bank_axi,{}" *) (* CORE_GENERATION_INFO = "cpu_hdmi_system_fir_coeff_bank_axi_0_2,fir_coeff_bank_axi,{x_ipProduct=Vivado 2025.2,x_ipVendor=xilinx.com,x_ipLibrary=user,x_ipName=fir_coeff_bank_axi,x_ipVersion=1.0,x_ipCoreRevision=2,x_ipLanguage=VERILOG,x_ipSimLanguage=MIXED,C_S00_AXI_DATA_WIDTH=32,C_S00_AXI_ADDR_WIDTH=7}" *) (* DowngradeIPIdentifiedWarnings = "yes" *) 
