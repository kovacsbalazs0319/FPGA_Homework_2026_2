...
#                script (type 'cpu_hdmi_system.sh -help' for more information).
#
...
map_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="C:/Users/Balazs/Desktop/MSC1/FPGA/homework/HDMI_FIR_Homework.cache/compile_simlib/activehdl"
  fi
  if [[ ($lib_map_path != "") ]]; then
