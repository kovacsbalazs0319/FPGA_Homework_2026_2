...
#
# Script generated by Vivado on Mon Jun 08 16:22:41 +0200 2026
# SW Build 6299465 on Fri Nov 14 19:35:11 GMT 2025
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2025 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : cpu_hdmi_system.sh
...
#
# Usage        : cpu_hdmi_system.sh
#                cpu_hdmi_system.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                cpu_hdmi_system.sh [-rerun]
#                cpu_hdmi_system.sh [-reset_run]
#                cpu_hdmi_system.sh [-clean]
#                cpu_hdmi_system.sh [-reset_log]
#                cpu_hdmi_system.sh [-help]
#
...
# script info
echo -e "cpu_hdmi_system.sh - Script generated by export_simulation (Vivado v2025.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./cpu_hdmi_system.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L microblaze_v11_0_16 -L microblaze_riscv_v1_0_7 -L lmb_v10_v3_0_16 -L lmb_bram_if_cntlr_v4_0_27 -L blk_mem_gen_v8_4_12 -L proc_sys_reset_v5_0_17 -L smartconnect_v1_0 -L axi_infrastructure_v1_1_0 -L axi_register_slice_v2_1_36 -L axi_vip_v1_1_22 -L axi_lite_ipif_v3_0_4 -L mdm_riscv_v1_0_7 -L axi_uartlite_v2_0_39 -L uvm -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot cpu_hdmi_system xil_defaultlib.cpu_hdmi_system xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim cpu_hdmi_system -key {Behavioral:sim_1:Functional:cpu_hdmi_system} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_af15.protoinst" -protoinst "protoinst_files/cpu_hdmi_system.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb cpu_hdmi_system.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./cpu_hdmi_system.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: cpu_hdmi_system.sh [-help]\n\
Usage: cpu_hdmi_system.sh [-step]\n\
Usage: cpu_hdmi_system.sh [-lib_map_path]\n\
Usage: cpu_hdmi_system.sh [-rerun]\n\
Usage: cpu_hdmi_system.sh [-reset_run]\n\
Usage: cpu_hdmi_system.sh [-clean]\n\
Usage: cpu_hdmi_system.sh [-reset_log]\n\
Usage: cpu_hdmi_system.sh [-keep_index]\n\
Usage: cpu_hdmi_system.sh [-noclean_files]\n\n\
