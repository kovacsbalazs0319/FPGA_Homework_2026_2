...
REM
REM Generated by Vivado on Sat May 30 17:49:59 +0200 2026
...
echo "xvlog --incr --relax -prj tb_line_buffer_chain_vlog.prj"
call xvlog  --incr --relax -prj tb_line_buffer_chain_vlog.prj -log xvlog.log
