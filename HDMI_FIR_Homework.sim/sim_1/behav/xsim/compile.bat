...
REM
REM Generated by Vivado on Sat Jun 06 11:41:32 +0200 2026
...
echo "xvlog --incr --relax -prj tb_fir_picture_vlog.prj"
call xvlog  --incr --relax -prj tb_fir_picture_vlog.prj -log xvlog.log
